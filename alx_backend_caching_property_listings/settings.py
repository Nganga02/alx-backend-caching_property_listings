...
SECRET_KEY = 'django-insecure-42tp8u=b1)-yp3m8+r0yb*$o0ox2swius+48#ewc0^2p!o399q'
...
# Now you can use os.environ.get() to access them
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis:6379/1",#We are using the second database 
        "OPTIONS": {
